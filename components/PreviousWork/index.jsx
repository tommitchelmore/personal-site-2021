    ...
    return (
        <section>
            <Container noVertical>
                {onHomePage && <>
                    <h1 className="text-6xl 2xl:text-8xl pt-10 mt-10">Featured Work</h1>
                    <p className="mt-4 text-xl">You can view all of my work <Link href="/work"><a className="text-secondary">here</a></Link>.</p>
                </>}
