    ...
    return (
        ...
        >
            <div className="bg-primary text-white w-3/4 lg:w-1/2 xl:w-1/3 p-10 rounded-xl">
                ...
                <p className="mb-5">You're currently viewing the beta version of my new website - please be aware that lot's of things will be broken, experimental or completely missing!</p>
                <div className="flex mb-5">
                    <Link href="https://tommitchelmore.com"><a rel="noopener noreferrer" className="bg-white text-black p-2 mr-5 text-xs rounded-sm">
                        Main site
                    </a></Link>
                    <button className="bg-warning text-white p-2 text-xs rounded-sm" onClick={handleAccept}>
